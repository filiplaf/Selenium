...
public static String mecevi;	
	...
	try {
	JSONObject jsonObject = (JSONObject) jsonParser.parse(new FileReader("C:\\Git workspace\\Selenium\\WebAutomation\\src\\main\\java\\resources\\meceviGermania.json"));
	...
	public static void pustanjeMecevaNaSajt() {
		...
		RestAssured.baseURI ="http://192.168.179.64";
		String json = "{\r\n" + 
				"\"matchIds\": ["+mecevi+"],\r\n" + 
