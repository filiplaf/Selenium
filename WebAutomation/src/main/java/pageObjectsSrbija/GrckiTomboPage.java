...
public class GrckiTomboPage {
		...
		By GrckiTombo2 = By.cssSelector("div#spa div.vb-content > div:nth-child(1) > div");
		By GrckiTombo2Time = By.cssSelector("div#pageWrapper li.active.g2");
		...
		By title = By.xpath("//*[contains(text(), 'tombo 2 tiket')]");
		By title1 = By.xpath("//*[contains(text(), 'tombo 3 tiket')]");
		By title2 = By.xpath("//*[contains(text(), 'tombo 4 tiket')]");
		By title3 = By.xpath("//*[contains(text(), 'tombo 5 tiket')]");	
